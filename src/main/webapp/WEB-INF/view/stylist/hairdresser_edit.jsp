...
<body>
	<div class="container">
		...
		<div class="input_list">
			...
			<div class="input_one">
				<span>电话</span>
				<div class="input_info_main">
					<input readonly="readonly" type="text" placeholder="输入联系电话" id="phoneNumber" value="${hairdresser.phoneNumber}" />
				</div>
				<hr style="background: #f2f2f2;height: 1px;border: none">
			</div>
			<div class="input_one">
	...
	var save_url = '<c:url value="/stylist/hairdresser/save"/>';
	    ...
	    $.ajax({
			...
			success : function(data) {
			    if (data != null && data.code == 200) {
				  ...
				  window.location.href='<c:url value="/stylist/hairdresser/detail"/>';
			    } else {
