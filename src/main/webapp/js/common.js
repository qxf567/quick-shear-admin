...
function pop_up_alert(type,msg)
{
    ...
    setTimeout(function(){$(".pop_box").remove();},3000);
}
...
//    $("body").append('<div class="loading_box" style="display:none; "><div class="loading_main"><table width="100%" cellpadding="0" cellspacing="0" border="0" ><tr><td align="center"><img src="http://www.qiansishun.com:8180/admin.img/loading.gif"></td></tr></table></div></div>');
//
//    $("a").click(function(){
