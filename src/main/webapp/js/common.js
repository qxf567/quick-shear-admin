...
$(document).ready(function(){
    $("body").append('<div class="loading_box" style="display:none; "><div class="loading_main"><table width="100%" cellpadding="0" cellspacing="0" border="0" ><tr><td align="center"><img src="http://60.205.150.77:8180/admin.img/loading.gif"></td></tr></table></div></div>');
